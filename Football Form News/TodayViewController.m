...
- (void)loadData {
    ...
    //if (items == nil) {
        ...
        [rssParser parseRssFeed:@"http://www.goal.com/en/feeds/news?fmt=rss&ICID=HP" withDelegate:self];
...
-(void)showTxtLabel {
    ...
    //self.preferredContentSize = CGSizeMake(0, 21+8);
...
- (IBAction)viewMoreArticles:(id)sender {
    ...
    NSString *link = @"footballform://news/international";
